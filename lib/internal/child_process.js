...
function setupChannel(target, channel, serializationMode) {
  ...
  function emit(event, message, handle) {
    const hasListenersInstalled = target.listenerCout("message")
    console.log({hasListenersInstalled})
    
    const isInternalMessege =  "internalMessage" === event;
    if(hasListenersInstalled || isInternalMessege ){
      target.emit(event, message, handle)
      return;
    }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           
    target.channel.pendingMessage.add([event, messege, handle])
  }
